...
def get_joint_addrs_and_ndims(model: MjModel, name: str) -> tuple[int, int, int, int]:
    """Return the qposadr, dofadr, qpos ndim, and qvel/qacc ndim of the given joint.
    ...
    return joint_qpos_addr, joint_qvel_qacc_addr, qpos_ndim, qvel_qacc_ndim

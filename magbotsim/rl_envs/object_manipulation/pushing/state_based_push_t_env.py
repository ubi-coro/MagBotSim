...
class StateBasedPushTEnv(StateBasedGlobalPushingEnv):
    """An environment for the Push-T object pushing task.
    ...
    def __init__(
        ...
        super().__init__(
            ...
            a_max_xy=a_max_xy,
            j_max_xy=j_max_xy,
            learn_mover_c_rotation=learn_mover_c_rotation,
            p_max_c=p_max_c,
            v_max_c=v_max_c,
            a_max_c=a_max_c,
            j_max_c=j_max_c,
...
class StateBasedPushTEnvB0(StateBasedPushTEnv):
    """Benchmark 0 for the :class:`StateBasedPushTEnv` task."""
    ...
    def __init__(
        ...
        super().__init__(
            num_movers=BENCHMARK_PUSHING_NUM_MOVERS[0],
            mover_params=mover_params,
            layout_tiles=BENCHMARK_PUSHING_LAYOUTS[0],
            initial_mover_zpos=initial_mover_zpos,
            std_noise=std_noise,
            render_mode=render_mode,
            render_every_cycle=render_every_cycle,
...
class StateBasedPushTEnvB1(StateBasedPushTEnv):
    """Benchmark 1 for the :class:`StateBasedPushTEnv` task."""
    ...
    def __init__(
        ...
        super().__init__(
            num_movers=BENCHMARK_PUSHING_NUM_MOVERS[1],
            mover_params=mover_params,
            layout_tiles=BENCHMARK_PUSHING_LAYOUTS[1],
            initial_mover_zpos=initial_mover_zpos,
            std_noise=std_noise,
            render_mode=render_mode,
            render_every_cycle=render_every_cycle,
...
class StateBasedPushTEnvB2(StateBasedPushTEnv):
    """Benchmark 2 for the :class:`StateBasedPushTEnv` task."""
    ...
    def __init__(
        ...
        super().__init__(
            num_movers=BENCHMARK_PUSHING_NUM_MOVERS[2],
            mover_params=mover_params,
            layout_tiles=BENCHMARK_PUSHING_LAYOUTS[2],
            initial_mover_zpos=initial_mover_zpos,
            std_noise=std_noise,
            render_mode=render_mode,
            render_every_cycle=render_every_cycle,
...
class StateBasedPushTEnvB3(StateBasedPushTEnv):
    """Benchmark 3 for the :class:`StateBasedPushTEnv` task."""
    ...
    def __init__(
        ...
        super().__init__(
            num_movers=BENCHMARK_PUSHING_NUM_MOVERS[3],
            mover_params=mover_params,
            layout_tiles=BENCHMARK_PUSHING_LAYOUTS[3],
            initial_mover_zpos=initial_mover_zpos,
            std_noise=std_noise,
            render_mode=render_mode,
            render_every_cycle=render_every_cycle,
...
class StateBasedPushTEnvB4(StateBasedPushTEnv):
    """Benchmark 4 for the :class:`StateBasedPushTEnv` task."""
    ...
    def __init__(
        ...
        super().__init__(
            num_movers=BENCHMARK_PUSHING_NUM_MOVERS[4],
            mover_params=mover_params,
            layout_tiles=BENCHMARK_PUSHING_LAYOUTS[4],
            initial_mover_zpos=initial_mover_zpos,
            std_noise=std_noise,
            render_mode=render_mode,
            render_every_cycle=render_every_cycle,
...
class StateBasedPushTEnvB5(StateBasedPushTEnv):
    """Benchmark 5 for the :class:`StateBasedPushTEnv` task."""
    ...
    def __init__(
        ...
        super().__init__(
            num_movers=BENCHMARK_PUSHING_NUM_MOVERS[5],
            mover_params=mover_params,
            layout_tiles=BENCHMARK_PUSHING_LAYOUTS[5],
            initial_mover_zpos=initial_mover_zpos,
            std_noise=std_noise,
            render_mode=render_mode,
            render_every_cycle=render_every_cycle,
...
class StateBasedPushTEnvB6(StateBasedPushTEnv):
    """Benchmark 6 for the :class:`StateBasedPushTEnv` task."""
    ...
    def __init__(
        ...
        super().__init__(
            num_movers=BENCHMARK_PUSHING_NUM_MOVERS[6],
            mover_params=mover_params,
            layout_tiles=BENCHMARK_PUSHING_LAYOUTS[6],
            initial_mover_zpos=initial_mover_zpos,
            std_noise=std_noise,
            render_mode=render_mode,
            render_every_cycle=render_every_cycle,
...
class StateBasedPushTEnvB7(StateBasedPushTEnv):
    """Benchmark 7 for the :class:`StateBasedPushTEnv` task."""
    ...
    def __init__(
        ...
        super().__init__(
            num_movers=BENCHMARK_PUSHING_NUM_MOVERS[7],
            mover_params=mover_params,
            layout_tiles=BENCHMARK_PUSHING_LAYOUTS[7],
            initial_mover_zpos=initial_mover_zpos,
            std_noise=std_noise,
            render_mode=render_mode,
            render_every_cycle=render_every_cycle,
...
class StateBasedPushTEnvB8(StateBasedPushTEnv):
    """Benchmark 8 for the :class:`StateBasedPushTEnv` task."""
    ...
    def __init__(
        ...
        super().__init__(
            num_movers=BENCHMARK_PUSHING_NUM_MOVERS[8],
            mover_params=mover_params,
            layout_tiles=BENCHMARK_PUSHING_LAYOUTS[8],
            initial_mover_zpos=initial_mover_zpos,
            std_noise=std_noise,
            render_mode=render_mode,
            render_every_cycle=render_every_cycle,
...
class StateBasedPushTEnvB9(StateBasedPushTEnv):
    """Benchmark 9 for the :class:`StateBasedPushTEnv` task."""
    ...
    def __init__(
        ...
        super().__init__(
            num_movers=BENCHMARK_PUSHING_NUM_MOVERS[9],
            mover_params=mover_params,
            layout_tiles=BENCHMARK_PUSHING_LAYOUTS[9],
            initial_mover_zpos=initial_mover_zpos,
            std_noise=std_noise,
            render_mode=render_mode,
            render_every_cycle=render_every_cycle,

...
class StateBasedPushTEnvB0(StateBasedPushTEnv):
    ...
    def __init__(
        ...
        super().__init__(
            BENCHMARK_PUSHING_NUM_MOVERS[0],
            mover_params,
            BENCHMARK_PUSHING_LAYOUTS[0],
            initial_mover_zpos,
            std_noise,
            render_mode,
            render_every_cycle,
...
class StateBasedPushTEnvB1(StateBasedPushTEnv):
    ...
    def __init__(
        ...
        super().__init__(
            BENCHMARK_PUSHING_NUM_MOVERS[1],
            mover_params,
            BENCHMARK_PUSHING_LAYOUTS[1],
            initial_mover_zpos,
            std_noise,
            render_mode,
            render_every_cycle,
...
class StateBasedPushTEnvB2(StateBasedPushTEnv):
    ...
    def __init__(
        ...
        super().__init__(
            BENCHMARK_PUSHING_NUM_MOVERS[2],
            mover_params,
            BENCHMARK_PUSHING_LAYOUTS[2],
            initial_mover_zpos,
            std_noise,
            render_mode,
            render_every_cycle,
...
class StateBasedPushTEnvB3(StateBasedPushTEnv):
    ...
    def __init__(
        ...
        super().__init__(
            BENCHMARK_PUSHING_NUM_MOVERS[3],
            mover_params,
            BENCHMARK_PUSHING_LAYOUTS[3],
            initial_mover_zpos,
            std_noise,
            render_mode,
            render_every_cycle,
...
class StateBasedPushTEnvB4(StateBasedPushTEnv):
    ...
    def __init__(
        ...
        super().__init__(
            BENCHMARK_PUSHING_NUM_MOVERS[4],
            mover_params,
            BENCHMARK_PUSHING_LAYOUTS[4],
            initial_mover_zpos,
            std_noise,
            render_mode,
            render_every_cycle,
...
class StateBasedPushTEnvB5(StateBasedPushTEnv):
    ...
    def __init__(
        ...
        super().__init__(
            BENCHMARK_PUSHING_NUM_MOVERS[5],
            mover_params,
            BENCHMARK_PUSHING_LAYOUTS[5],
            initial_mover_zpos,
            std_noise,
            render_mode,
            render_every_cycle,
...
class StateBasedPushTEnvB6(StateBasedPushTEnv):
    ...
    def __init__(
        ...
        super().__init__(
            BENCHMARK_PUSHING_NUM_MOVERS[6],
            mover_params,
            BENCHMARK_PUSHING_LAYOUTS[6],
            initial_mover_zpos,
            std_noise,
            render_mode,
            render_every_cycle,
...
class StateBasedPushTEnvB7(StateBasedPushTEnv):
    ...
    def __init__(
        ...
        super().__init__(
            BENCHMARK_PUSHING_NUM_MOVERS[7],
            mover_params,
            BENCHMARK_PUSHING_LAYOUTS[7],
            initial_mover_zpos,
            std_noise,
            render_mode,
            render_every_cycle,
...
class StateBasedPushTEnvB8(StateBasedPushTEnv):
    ...
    def __init__(
        ...
        super().__init__(
            BENCHMARK_PUSHING_NUM_MOVERS[8],
            mover_params,
            BENCHMARK_PUSHING_LAYOUTS[8],
            initial_mover_zpos,
            std_noise,
            render_mode,
            render_every_cycle,
...
class StateBasedPushTEnvB9(StateBasedPushTEnv):
    ...
    def __init__(
        ...
        super().__init__(
            BENCHMARK_PUSHING_NUM_MOVERS[9],
            mover_params,
            BENCHMARK_PUSHING_LAYOUTS[9],
            initial_mover_zpos,
            std_noise,
            render_mode,
            render_every_cycle,

...
import pytest
import numpy as np
from magbotsim.rl_envs.object_manipulation.pushing.state_based_static_obstacle_env import StateBasedStaticObstaclePushingEnv
...
def test_jerk_actuator(mover_mass, jerk, num_cycles, test_x, test_y):
    ...
    env = StateBasedStaticObstaclePushingEnv(
